...
Players.PlayerAdded:Connect(function()
    Options.PlayerDropdown:Refresh() -- Refresh dropdown when a player joins
end)
Players.PlayerRemoving:Connect(function(player)
    if player == targetPlayer then
        targetPlayer = nil
        stopAttach()
        Options.PlayerDropdown:SetValue("") -- Reset dropdown selection
    end
    Options.PlayerDropdown:Refresh() -- Refresh dropdown when a player leaves
end)
